...
public final class km {
    ...
    public km(int i, int i2, float f, float f2, int i3) {
        this.a = i;
        this.f1135b = i2;
        this.c = f;
        this.d = f2;
    ...
    public final int a() {
        int i = this.m * this.f1135b;
        return i + i;
    }

    public final int b() {
        int i = this.k * this.f1135b;
        return i + i;
    }
    ...
    public final void d(ShortBuffer shortBuffer) {
        int min = Math.min(shortBuffer.remaining() / this.f1135b, this.m);
        shortBuffer.put(this.l, 0, this.f1135b * min);
        int i = this.m - min;
        this.m = i;
        short[] sArr = this.l;
        int i2 = this.f1135b;
    ...
    public final void e() {
        ...
        float f = this.c;
        float f2 = this.d;
        int i3 = this.m + ((int) ((((i2 / (f / f2)) + this.f1136o) / (this.e * f2)) + 0.5f));
        short[] sArr = this.j;
        int i4 = this.h;
    ...
    public final void f(ShortBuffer shortBuffer) {
        ...
        this.j = l;
        shortBuffer.get(l, this.k * this.f1135b, (i3 + i3) / 2);
        this.k += i2;
        k();
    }
    ...
    private final void k() {
                ...
                while (true) {
                    ...
                    if (i13 > 0) {
                        ...
                        if (d > 1.0d) {
                            ...
                            this.l = l;
                            int i24 = i3;
                            j(i3, this.f1135b, l, this.m, sArr2, i12, sArr2, i12 + i23);
                            this.m += i24;
                            i12 += i23 + i24;
                        } else {
                            int i25 = i23;
                            ...
                            j(i2, this.f1135b, this.l, this.m + i25, sArr3, i12 + i25, sArr3, i12);
                            this.m += i26;
                            i12 += i2;
                        }
                    }
        ...
        int i32 = this.m - i9;
        short[] l3 = l(this.n, this.f1136o, i32);
        this.n = l3;
        short[] sArr5 = this.l;
        int i33 = this.f1135b;
        System.arraycopy(sArr5, i9 * i33, l3, this.f1136o * i33, i33 * i32);
        this.m = i9;
        this.f1136o += i32;
        int i34 = 0;
        while (true) {
