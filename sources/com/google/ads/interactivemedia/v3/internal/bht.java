...
final class bht {
    ...
    private static final int[] f839b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};
    ...
    public static byte[] j(long[] jArr) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            ...
            while (i9 < 9) {
                ...
                copyOf[i9] = j2 + (i7 << i6);
                i9++;
                copyOf[i9] = copyOf[i9] - (-((int) (((j2 >> 31) & j2) >> d[i9 & 1])));
            }
            long j3 = copyOf[9];
        ...
        for (int i11 = 0; i11 < 2; i11++) {
            ...
            while (i12 < 9) {
                ...
                copyOf[i12] = c[i5] & j5;
                i12++;
                copyOf[i12] = copyOf[i12] + ((int) (j5 >> i13));
            }
        }
        ...
        for (int i15 = 1; i15 < 10; i15++) {
            int i16 = ~(c[i15 & 1] ^ ((int) copyOf[i15]));
            int i17 = i16 & (i16 << 16);
            int i18 = i17 & (i17 << 8);
            int i19 = i18 & (i18 << 4);
            int i20 = i19 & (i19 << 2);
        ...
        for (int i23 = 0; i23 < 10; i23++) {
            copyOf[i23] = copyOf[i23] << f839b[i23];
        }
    ...
    public static long[] k(byte[] bArr) {
        ...
        for (int i = 0; i < 10; i++) {
            int i2 = a[i];
            jArr[i] = (((((bArr[i2] & 255) | ((bArr[i2 + 1] & 255) << 8)) | ((bArr[i2 + 2] & 255) << 16)) | ((bArr[i2 + 3] & 255) << 24)) >> f839b[i]) & c[i & 1];
        }
        return jArr;
    }
}
