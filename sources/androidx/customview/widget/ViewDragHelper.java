    ...
    */
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            int i3 = this.mInitialEdgesTouched[pointerId] & this.mTrackingEdges;
            if (i3 != 0) {
                this.mCallback.onEdgeTouched(i3, pointerId);
            }
            ...
            if (this.mDragState == 0) {
                ...
                int i7 = this.mInitialEdgesTouched[pointerId3] & this.mTrackingEdges;
                if (i7 != 0) {
                    this.mCallback.onEdgeTouched(i7, pointerId3);
                }
