...
public final class startAlphaAnimation {
    ...
    public static long ag$a(AtomicLong atomicLong, long j) {
        ...
        } while (!atomicLong.compareAndSet(j2, ag$a(j2, j)));
        return j2;
    }

    public static long valueOf(AtomicLong atomicLong, long j) {
        long j2;
        do {
            j2 = atomicLong.get();
    ...
    public static long toString(AtomicLong atomicLong, long j) {
        ...
        do {
            ...
            j3 = j2 - j;
            if (j3 < 0) {
                setProgressBackgroundColor.values(new IllegalStateException("More produced than requested: " + j3));
                j3 = 0L;
            }
