...
public final class GlideException extends Exception {
    ...
    public void setLoggingDetails(getDescendants getdescendants, DataSource dataSource) {
        setLoggingDetails(getdescendants, dataSource, null);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void setLoggingDetails(getDescendants getdescendants, DataSource dataSource, Class<?> cls) {
        this.key = getdescendants;
    ...
    private void printStackTrace(final Appendable appendable) {
        ...
        appendCauses(getCauses(), new Appendable(appendable) { // from class: com.bumptech.glide.load.engine.GlideException$ag$a
            private final Appendable ah$a;
            private boolean valueOf = true;

            private CharSequence valueOf(CharSequence charSequence) {
                return charSequence == null ? "" : charSequence;
            }

            /* JADX INFO: Access modifiers changed from: package-private */
            {
                this.ah$a = appendable;
            }
            ...
            public Appendable append(CharSequence charSequence) throws IOException {
                ...
                return append(valueOf, 0, valueOf.length());
            }
            ...
            public Appendable append(CharSequence charSequence, int i, int i2) throws IOException {
                ...
                if (valueOf.length() > 0 && valueOf.charAt(i2 - 1) == '\n') {
                    z = true;
                }
                this.valueOf = z;
                this.ah$a.append(valueOf, i, i2);
                return this;
            }
        });
    }
