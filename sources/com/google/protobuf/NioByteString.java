...
public final class NioByteString extends ByteString.LeafByteString {
    ...
    public void writeToInternal(OutputStream outputStream, int i, int i2) throws IOException {
        ...
        popEnd.values(slice(i, i2 + i), outputStream);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.google.protobuf.ByteString
    public void writeTo(getLayoutParams getlayoutparams) throws IOException {
        getlayoutparams.toString(this.buffer.slice());
    }
    ...
    public boolean isValidUtf8() {
        return Utf8.toString(this.buffer);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.google.protobuf.ByteString
    public int partialIsValidUtf8(int i, int i2, int i3) {
        return Utf8.valueOf(i, this.buffer, i2, i3 + i2);
    }
    ...
    public InputStream newInput() {
        return new InputStream() { // from class: com.google.protobuf.NioByteString.3
            ...
            {
                this.values = NioByteString.this.buffer.slice();
            }
            ...
            public int available() throws IOException {
                return this.values.remaining();
            }

            @Override // java.io.InputStream
            public int read() throws IOException {
                if (this.values.hasRemaining()) {
            ...
            public int read(byte[] bArr, int i, int i2) throws IOException {
                if (this.values.hasRemaining()) {
                    int min = Math.min(i2, this.values.remaining());
                    this.values.get(bArr, i, min);
                    return min;
                }
                return -1;
            }
    ...
    public getStartLine newCodedInput() {
        return getStartLine.toString(this.buffer, true);
    }
