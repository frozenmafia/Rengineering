...
public final class MlltFrame extends Id3Frame {
    ...
    public int hashCode() {
        int i = this.mpegFramesBetweenReference;
        int i2 = this.bytesBetweenReference;
        int i3 = this.millisecondsBetweenReference;
        return ((((((((i + BR.userTeamVM) * 31) + i2) * 31) + i3) * 31) + Arrays.hashCode(this.bytesDeviations)) * 31) + Arrays.hashCode(this.millisecondsDeviations);
    }
