...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    */
    public static com.sendbird.android.shadow.okio.Options of(com.sendbird.android.shadow.okio.ByteString... r10) {
        /*
            Method dump skipped, instructions count: 264
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sendbird.android.shadow.okio.Options.of(com.sendbird.android.shadow.okio.ByteString[]):com.sendbird.android.shadow.okio.Options");
    }
    ...
    private static void buildTrieRecursive(long j, Buffer buffer, int i, List<ByteString> list, int i2, int i3, List<Integer> list2) {
        ...
        if (byteString.getByte(i) != byteString2.getByte(i)) {
            ...
            for (int i13 = i10; i13 < i3; i13++) {
                ...
                if (i13 == i10 || b2 != list.get(i13 - 1).getByte(i)) {
            ...
            int i14 = i10;
            while (i14 < i3) {
                byte b3 = list.get(i14).getByte(i);
                int i15 = i14 + 1;
                int i16 = i15;
                while (true) {
                    if (i16 >= i3) {
                        i5 = i3;
                        break;
                    } else if (b3 != list.get(i16).getByte(i)) {
                        i5 = i16;
                        break;
                    } else {
                        i16++;
