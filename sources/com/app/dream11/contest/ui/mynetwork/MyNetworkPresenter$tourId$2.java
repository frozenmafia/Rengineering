...
public final class MyNetworkPresenter$tourId$2 extends Lambda implements Styleable.ArcMotion<Integer> {
    final /* synthetic */ AnimatedStateListDrawableCompat.AnimatedVectorDrawableTransition this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MyNetworkPresenter$tourId$2(AnimatedStateListDrawableCompat.AnimatedVectorDrawableTransition animatedVectorDrawableTransition) {
        super(0);
    ...
    public final Integer invoke() {
        ...
        return Integer.valueOf(myNetworkFlowState == null ? -1 : myNetworkFlowState.getTourId());
    }
}
