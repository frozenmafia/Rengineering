...
public final class PlayerInfoVm$onPlayerRemoveClick$1 extends Lambda implements Styleable.ArcMotion<setAnimationMatrix> {
    final /* synthetic */ areUnusedAppRestrictionsAvailable this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PlayerInfoVm$onPlayerRemoveClick$1(areUnusedAppRestrictionsAvailable areunusedapprestrictionsavailable) {
        super(0);
    ...
    public final void invoke2() {
        ...
        this.this$0.valueOf().values(player.getId(), player.getType().getShortName());
    }
}
