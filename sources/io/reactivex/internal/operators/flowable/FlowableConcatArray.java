...
public final class FlowableConcatArray<T> extends SimpleSQLiteQuery<T> {
    final boolean ah$a;
    final getSidecar<? extends T>[] valueOf;
    ...
    public void values(registerConfigurationChangeListener<? super T> registerconfigurationchangelistener) {
        ConcatArraySubscriber concatArraySubscriber = new ConcatArraySubscriber(this.valueOf, this.ah$a, registerconfigurationchangelistener);
        registerconfigurationchangelistener.onSubscribe(concatArraySubscriber);
        concatArraySubscriber.onComplete();
    }

    /* loaded from: classes7.dex */
    static final class ConcatArraySubscriber<T> extends SubscriptionArbiter implements SupportSQLiteOpenHelper<T> {
