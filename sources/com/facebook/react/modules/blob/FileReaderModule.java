...
@FragmentStateManager.AnonymousClass1(values = FileReaderModule.NAME)
...
public class FileReaderModule extends NativeFileReaderModuleSpec {
    ...
    public void readAsText(ReadableMap readableMap, String str, Promise promise) {
        ...
        byte[] resolve = blobModule.resolve(readableMap.getString("blobId"), readableMap.getInt("offset"), readableMap.getInt(StringSet.size));
        if (resolve == null) {
