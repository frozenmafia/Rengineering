        ...
        if (i2 >= 0) {
            ...
            while (i3 < i2) {
                ...
                if (context.modulus == 0) {
                    int i5 = context.pos;
                    context.pos = i5 + 1;
                    ensureBufferSize[i5] = this.encodeTable[(context.ibitWorkArea >> 18) & 63];
                    int i6 = context.pos;
                    context.pos = i6 + 1;
                    ensureBufferSize[i6] = this.encodeTable[(context.ibitWorkArea >> 12) & 63];
                    int i7 = context.pos;
                    context.pos = i7 + 1;
                    ensureBufferSize[i7] = this.encodeTable[(context.ibitWorkArea >> 6) & 63];
                    int i8 = context.pos;
                    context.pos = i8 + 1;
                    ensureBufferSize[i8] = this.encodeTable[context.ibitWorkArea & 63];
