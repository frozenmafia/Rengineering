...
public final class zzkn {
    ...
    public static BigInteger zzc(BigInteger bigInteger, boolean z, EllipticCurve ellipticCurve) throws GeneralSecurityException {
                        ...
                        if (!modPow.add(BigInteger.ONE).equals(zzb)) {
                            ...
                            for (int bitLength = shiftRight2.bitLength() - 2; bitLength >= 0; bitLength--) {
                                ...
                                if (shiftRight2.testBit(bitLength)) {
                                    BigInteger mod6 = mod4.multiply(bigInteger2).add(mod5.multiply(mod3)).mod(zzb);
                                    bigInteger4 = bigInteger2.multiply(mod5).add(mod4).mod(zzb);
                                    bigInteger5 = mod6;
                                } else {
                                    bigInteger5 = mod4;
                                    bigInteger4 = mod5;
        ...
        return z != bigInteger3.testBit(0) ? zzb.subtract(bigInteger3).mod(zzb) : bigInteger3;
    }
