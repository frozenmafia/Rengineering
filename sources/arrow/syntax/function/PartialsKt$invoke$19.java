...
public final class PartialsKt$invoke$19 extends Lambda implements excludeId<P1, P2, P3, P4, P6, R> {
    final /* synthetic */ Object $p5;
    final /* synthetic */ isValidMatch $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$19(isValidMatch isvalidmatch, Object obj) {
        super(5);
    ...
    public final R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P6 p6) {
        return this.$this_invoke.invoke(p1, p2, p3, p4, this.$p5, p6);
    }
}
