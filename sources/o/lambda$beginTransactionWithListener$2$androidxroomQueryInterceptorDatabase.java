...
public class lambda$beginTransactionWithListener$2$androidxroomQueryInterceptorDatabase {
    ...
    public static Curve values(ECParameterSpec eCParameterSpec) {
        if (eCParameterSpec == null) {
            return null;
        }
        int fieldSize = eCParameterSpec.getCurve().getField().getFieldSize();
        ECParameterSpec eCParameterSpec2 = toString;
        ...
        ECParameterSpec eCParameterSpec3 = ag$a;
        ...
        ECParameterSpec eCParameterSpec4 = valueOf;
        ...
        ECParameterSpec eCParameterSpec5 = ah$a;
