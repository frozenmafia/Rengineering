...
public final class AtomicLongMap<K> implements Serializable {
    ...
    private AtomicLongMap(ConcurrentHashMap<K, AtomicLong> concurrentHashMap) {
        this.map = (ConcurrentHashMap) markViewHoldersUpdated.toString(concurrentHashMap);
    }
    ...
    private Map<K, Long> createAsMap() {
        return Collections.unmodifiableMap(Maps.values((Map) this.map, (hasPendingUpdates) new hasPendingUpdates<AtomicLong, Long>(this) { // from class: com.google.common.util.concurrent.AtomicLongMap.5
