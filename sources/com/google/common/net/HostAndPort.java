...
public final class HostAndPort implements Serializable {
    ...
    public int getPort() {
        markViewHoldersUpdated.ag$a(hasPort());
        return this.port;
    }
    ...
    public static HostAndPort fromParts(String str, int i) {
        markViewHoldersUpdated.values(isValidPort(i), "Port out of range: %s", i);
        HostAndPort fromString = fromString(str);
        markViewHoldersUpdated.toString(!fromString.hasPort(), "Host has a port: %s", str);
    ...
    */
    public static com.google.common.net.HostAndPort fromString(java.lang.String r8) {
        /*
            o.markViewHoldersUpdated.toString(r8)
            java.lang.String r0 = "["
        ...
        L37:
            ...
            r0 = r7
        L3c:
            boolean r6 = o.offsetPositionsForMove.valueOf(r0)
            if (r6 != 0) goto L85
            java.lang.String r1 = "+"
            boolean r1 = r0.startsWith(r1)
            if (r1 != 0) goto L55
            o.applyPendingUpdatesToPosition r1 = o.applyPendingUpdatesToPosition.values()
            boolean r1 = r1.valueOf(r0)
            if (r1 == 0) goto L55
            goto L56
        L55:
            r2 = 0
        L56:
            ...
            o.markViewHoldersUpdated.toString(r2, r1, r8)
            ...
            o.markViewHoldersUpdated.toString(r0, r2, r8)
            goto L85
        L69:
    ...
    private static String[] getHostAndPortFromBracketedHost(String str) {
        markViewHoldersUpdated.toString(str.charAt(0) == '[', "Bracketed host-port string must start with a bracket: %s", str);
        int indexOf = str.indexOf(58);
        int lastIndexOf = str.lastIndexOf(93);
        markViewHoldersUpdated.toString(indexOf > -1 && lastIndexOf > indexOf, "Invalid bracketed host/port: %s", str);
        String substring = str.substring(1, lastIndexOf);
        int i = lastIndexOf + 1;
        if (i == str.length()) {
            return new String[]{substring, ""};
        }
        markViewHoldersUpdated.toString(str.charAt(i) == ':', "Only a colon may follow a close bracket: %s", str);
        int i2 = lastIndexOf + 2;
        for (int i3 = i2; i3 < str.length(); i3++) {
            markViewHoldersUpdated.toString(Character.isDigit(str.charAt(i3)), "Port must be numeric: %s", str);
        }
        return new String[]{substring, str.substring(i2)};
    }

    public HostAndPort withDefaultPort(int i) {
        markViewHoldersUpdated.values(isValidPort(i));
        return hasPort() ? this : new HostAndPort(this.host, i, this.hasBracketlessColons);
    }

    public HostAndPort requireBracketsForIPv6() {
        markViewHoldersUpdated.toString(!this.hasBracketlessColons, "Possible bracketless IPv6 literal: %s", this.host);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HostAndPort) {
            ...
            return recycleUpdateOp.values(this.host, hostAndPort.host) && this.port == hostAndPort.port;
        }
        return false;
    }

    public int hashCode() {
        return recycleUpdateOp.valueOf(this.host, Integer.valueOf(this.port));
    }
