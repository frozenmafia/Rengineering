...
public enum bth implements bpm {
    LOGSID_NONE(0),
    LOGSID_IP_ADDRESS(1),
    ...
    private static final bpn T = new bpn() { // from class: com.google.ads.interactivemedia.v3.internal.btg
        @Override // com.google.ads.interactivemedia.v3.internal.bpn
        public final /* synthetic */ bpm a(int i) {
            return bth.b(i);
        }
    };
    private final int V;
