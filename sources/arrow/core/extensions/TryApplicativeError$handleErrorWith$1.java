...
public final class TryApplicativeError$handleErrorWith$1 extends Lambda implements Styleable.ChangeBounds<Throwable, ITrustedWebActivityService<? extends A>> {
    final /* synthetic */ Styleable.ChangeBounds $f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TryApplicativeError$handleErrorWith$1(Styleable.ChangeBounds changeBounds) {
        super(1);
        this.$f = changeBounds;
    }
