...
public interface zzsy {
    ...
    <T> T zza(zzsz<T> zzszVar, zzqp zzqpVar) throws IOException;

    <T> void zza(List<T> list, zzsz<T> zzszVar, zzqp zzqpVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzsd<K, V> zzsdVar, zzqp zzqpVar) throws IOException;

    @Deprecated
    <T> T zzb(zzsz<T> zzszVar, zzqp zzqpVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzsz<T> zzszVar, zzqp zzqpVar) throws IOException;
