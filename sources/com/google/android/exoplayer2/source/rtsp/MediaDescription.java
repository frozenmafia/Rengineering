...
public final class MediaDescription {
    ...
    public static final class RtpMapAttribute {
        ...
        public static RtpMapAttribute parse(String str) throws ParserException {
            String[] splitAtFirst = Util.splitAtFirst(str, Constants.WHITE_SPACE);
    ...
    public int hashCode() {
        ...
        int i = this.port;
        int hashCode2 = this.transportProtocol.hashCode();
        int i2 = this.payloadType;
        int i3 = this.bitrate;
        int hashCode3 = this.attributes.hashCode();
        int hashCode4 = this.rtpMapAttribute.hashCode();
    ...
    public ImmutableMap<String, String> getFmtpParametersAsMap() {
        ...
        ImmutableMap.valueOf valueof = new ImmutableMap.valueOf();
        for (String str2 : split) {
            String[] splitAtFirst2 = Util.splitAtFirst(str2, "=");
            valueof.toString(splitAtFirst2[0], splitAtFirst2[1]);
        }
        return valueof.ah$a();
    }
}
