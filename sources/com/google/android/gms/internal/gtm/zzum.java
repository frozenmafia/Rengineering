...
interface zzum {
    ...
    void zza(int i, zzps zzpsVar) throws IOException;

    <K, V> void zza(int i, zzsd<K, V> zzsdVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzsz zzszVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzsz zzszVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzsz zzszVar) throws IOException;

    void zzb(int i, List<zzps> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzsz zzszVar) throws IOException;
