...
public final class TrackGroup implements Bundleable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            this.hashCode = ((hashCode + BR.userTeamVM) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(keyForField(0), BundleableUtil.toBundleArrayList(Lists.valueOf(this.formats)));
