...
public final class ListK$padZipWith$1 extends Lambda implements Styleable.ChangeBounds<cancel<? extends ICustomTabsService.Stub.Proxy<? extends A>, ? extends ICustomTabsService.Stub.Proxy<? extends B>>, C> {
    final /* synthetic */ Transition $fa;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ListK$padZipWith$1(Transition transition) {
        super(1);
        this.$fa = transition;
    }
