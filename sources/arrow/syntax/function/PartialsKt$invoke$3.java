...
public final class PartialsKt$invoke$3 extends Lambda implements Transition<P2, P3, R> {
    final /* synthetic */ Object $p1;
    final /* synthetic */ excludeObject $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$3(excludeObject excludeobject, Object obj) {
        super(2);
    ...
    public final R invoke(P2 p2, P3 p3) {
        return this.$this_invoke.invoke(this.$p1, p2, p3);
    }
}
