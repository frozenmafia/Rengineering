...
public final class BlobProvider extends ContentProvider {
    private ExecutorService toString = Executors.newSingleThreadExecutor();
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        ...
        BlobModule blobModule = applicationContext instanceof onFragmentViewDestroyed ? (BlobModule) ((onFragmentViewDestroyed) applicationContext).ICustomTabsCallback().getInitSettings().valueOf().getNativeModule(BlobModule.class) : null;
        if (blobModule == null) {
        ...
        try {
            ...
            if (resolve.length <= 65536) {
                ...
                this.toString.submit(new Runnable() { // from class: com.facebook.react.modules.blob.BlobProvider.4
