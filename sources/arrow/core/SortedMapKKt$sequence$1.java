...
public final /* synthetic */ class SortedMapKKt$sequence$1 extends FunctionReference implements Styleable.ChangeBounds<ICustomTabsCallback.Default<? extends G, ? extends V>, ICustomTabsCallback.Default<? extends G, ? extends V>> {
    public static final SortedMapKKt$sequence$1 INSTANCE = new SortedMapKKt$sequence$1();

    SortedMapKKt$sequence$1() {
        super(1);
    }
