    ...
    public static MetadataList read(AssetManager assetManager, String str) throws IOException {
        try {
            ...
            try {
                ...
                try {
                    Object[] objArr = null;
                    InputStream inputStream = (InputStream) ((Class) AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$$ExternalSyntheticLambda2.valueOf(Process.getGidForName("") + 1, (char) (TypedValue.complexToFraction(0, 0.0f, 0.0f) > 0.0f ? 1 : (TypedValue.complexToFraction(0, 0.0f, 0.0f) == 0.0f ? 0 : -1)), 87 - TextUtils.getOffsetBefore("", 0))).getMethod("ah$a", AssetManager.class, String.class).invoke(null, assetManager, str);
                    try {
                        MetadataList read = read(inputStream);
                        if ((inputStream != null ? 'P' : (char) 11) != 11) {
                            int i3 = ah$a + 7;
                            toString = i3 % 128;
                            if (!(i3 % 2 == 0)) {
                                inputStream.close();
