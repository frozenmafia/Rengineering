...
public class UIManagerModuleConstantsHelper {
    ...
    public static Map<String, Object> getDefaultExportableEventTypes() {
        return destroyItem.ah$a(BUBBLING_EVENTS_KEY, UIManagerModuleConstants.getBubblingEventTypeConstants(), DIRECT_EVENTS_KEY, UIManagerModuleConstants.getDirectEventTypeConstants());
    }
    ...
    public static Map<String, Object> createConstants(List<ViewManager> list, Map<String, Object> map, Map<String, Object> map2) {
        ...
        for (ViewManager viewManager : list) {
            ...
            getLiveData.toString(0L, "UIManagerModuleConstantsHelper.createConstants").ag$a("ViewManager", name).ag$a("Lazy", false).ag$a();
            try {
    ...
    public static Map<String, Object> createConstantsForViewManager(ViewManager viewManager, Map map, Map map2, Map map3, Map map4) {
        ...
        if (exportedCustomBubblingEventTypeConstants != null) {
            ...
            values.put(BUBBLING_EVENTS_KEY, exportedCustomBubblingEventTypeConstants);
        } else if (map != null) {
            values.put(BUBBLING_EVENTS_KEY, map);
        }
        ...
        if (exportedCustomDirectEventTypeConstants != null) {
            ...
            values.put(DIRECT_EVENTS_KEY, exportedCustomDirectEventTypeConstants);
        } else if (map2 != null) {
            values.put(DIRECT_EVENTS_KEY, map2);
        }
        Map<String, Object> exportedViewConstants = viewManager.getExportedViewConstants();
        if (exportedViewConstants != null) {
            values.put("Constants", exportedViewConstants);
        }
        Map<String, Integer> commandsMap = viewManager.getCommandsMap();
        if (commandsMap != null) {
            values.put("Commands", commandsMap);
        }
        Map<String, String> nativeProps = viewManager.getNativeProps();
        if (!nativeProps.isEmpty()) {
            values.put("NativeProps", nativeProps);
        }
        return values;
    }
