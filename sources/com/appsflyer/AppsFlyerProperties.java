...
public class AppsFlyerProperties {
    ...
    public String getReferrer(Context context) {
        ...
        return ah.values(context).getString("referrer", null);
    }
    ...
    public void loadProperties(Context context) {
        synchronized (this) {
            ...
            String string = ah.values(context).getString("savedProperties", null);
            if (string != null) {
                AFLogger.AFKeystoreWrapper("Loading properties..");
                try {
                    ...
                    AFLogger.values("Failed loading properties", e);
                }
