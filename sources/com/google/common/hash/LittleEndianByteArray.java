...
final class LittleEndianByteArray {
    private static final LittleEndianByteArray$ag$a valueOf;

    /* loaded from: classes7.dex */
    enum JavaLittleEndianBytes implements LittleEndianByteArray$ag$a {
        INSTANCE { // from class: com.google.common.hash.LittleEndianByteArray.JavaLittleEndianBytes.1
            public long getLongLittleEndian(byte[] bArr, int i) {
                return Longs.ag$a(bArr[i + 7], bArr[i + 6], bArr[i + 5], bArr[i + 4], bArr[i + 3], bArr[i + 2], bArr[i + 1], bArr[i]);
            }
    ...
    /* loaded from: classes7.dex */
    enum UnsafeByteArray implements LittleEndianByteArray$ag$a {
        ...
        private static Unsafe getUnsafe() {
            try {
                ...
                return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.google.common.hash.LittleEndianByteArray.UnsafeByteArray.5
    ...
    static {
        LittleEndianByteArray$ag$a littleEndianByteArray$ag$a = JavaLittleEndianBytes.INSTANCE;
        try {
            if ("amd64".equals(System.getProperty("os.arch"))) {
                if (ByteOrder.nativeOrder().equals(ByteOrder.LITTLE_ENDIAN)) {
                    littleEndianByteArray$ag$a = UnsafeByteArray.UNSAFE_LITTLE_ENDIAN;
                } else {
                    littleEndianByteArray$ag$a = UnsafeByteArray.UNSAFE_BIG_ENDIAN;
                }
            }
        } catch (Throwable unused) {
        }
        valueOf = littleEndianByteArray$ag$a;
    }
}
