...
public abstract class AbstractFuture<V> implements animateAddImpl<V> {
    ...
    static {
        ...
        try {
            synchronizedHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, StringSet.next), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Object.class, "value"));
            th = null;
        } catch (Throwable th) {
            th = th;
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        SetFuture(AbstractFuture<V> abstractFuture, animateAddImpl<? extends V> animateaddimpl) {
    ...
    */
    ...
    static Object getFutureValue(animateAddImpl<?> animateaddimpl) {
        if (animateaddimpl instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) animateaddimpl).value;
            if (obj instanceof Cancellation) {
