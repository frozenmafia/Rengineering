...
final class zzzg extends zzyf<Double> implements RandomAccess, zzaab, zzabg {
    ...
    static {
        zzzg zzzgVar = new zzzg(new double[0], 0);
        zza = zzzgVar;
        zzzgVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzzgVar.zzb, 0, this.zzb, this.zzc, zzzgVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzzgVar.zzc) {
            return false;
        }
        double[] dArr = zzzgVar.zzb;
