...
public class ShareInviteHelper {
    public static void logInvite(Context context, String str, Map<String, String> map) {
        if (!TextUtils.isEmpty(str)) {
            ...
            AFLogger.AFKeystoreWrapper("[Invite] Reporting App-Invite via channel: ".concat(String.valueOf(str)));
        ...
        AFLogger.AFInAppEventParameterName("[Invite] Cannot report App-Invite with null/empty channel");
    }
