...
public final class CompositeException extends RuntimeException {
    ...
    public static abstract class toString {
        abstract void valueOf(Object obj);
    }
    ...
    public void printStackTrace(final PrintWriter printWriter) {
        printStackTrace(new toString(printWriter) { // from class: io.reactivex.exceptions.CompositeException$ag$a
            private final PrintWriter toString;
            ...
            @Override // io.reactivex.exceptions.CompositeException.toString
            void valueOf(Object obj) {
                this.toString.println(obj);
            }
        });
    }

    private void printStackTrace(toString tostring) {
    ...
    public static final class valueOf extends toString {
        private final PrintStream ah$a;

        valueOf(PrintStream printStream) {
            this.ah$a = printStream;
        }

        @Override // io.reactivex.exceptions.CompositeException.toString
        void valueOf(Object obj) {
            this.ah$a.println(obj);
        }
    }
