...
public abstract class SegmentBase {
    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public long getSegmentCount(long j) {
            ...
            if (j != C.TIME_UNSET) {
                return onViewRecycled.valueOf(BigInteger.valueOf(j).multiply(BigInteger.valueOf(this.timescale)), BigInteger.valueOf(this.duration).multiply(BigInteger.valueOf(1000000L)), RoundingMode.CEILING).longValue();
            }
            return -1L;
        }
    }
