...
public final class SequenceK$ap$1 extends Lambda implements Styleable.ChangeBounds<A, ICustomTabsService.Stub<? extends B>> {
    final /* synthetic */ ICustomTabsCallback.Default $ff;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SequenceK$ap$1(ICustomTabsCallback.Default r1) {
        super(1);
        this.$ff = r1;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: arrow.core.SequenceK$ap$1$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    ...
    @Override // o.Styleable.ChangeBounds
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return invoke((SequenceK$ap$1) obj);
    }

    @Override // o.Styleable.ChangeBounds
    public final ICustomTabsService.Stub<B> invoke(A a) {
