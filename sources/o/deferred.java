...
class deferred extends tokenizer {
    private Index HaptikSDK$b;
    private final boolean ah$b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public deferred(Context context, JSONObject jSONObject, boolean z) {
    ...
    public void valueOf(Index index) {
        this.HaptikSDK$b = index;
        try {
            this.valueOf = System.nanoTime();
            Sensor defaultSensor = this.HaptikSDK$a.getDefaultSensor(4);
            if (defaultSensor != null) {
                this.values.valueOf("g9", defaultSensor.getName());
                this.values.valueOf("h1", defaultSensor.getVendor());
                this.values.valueOf("h2", Float.valueOf(defaultSensor.getPower()));
                this.values.valueOf("h3", Integer.valueOf(defaultSensor.getVersion()));
                if (this.ah$b) {
                ...
                toString(new IMultiInstanceInvalidationCallback("Gyroscope sensor returns null"));
            }
        } catch (Exception e) {
    ...
    public void toString(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback) {
        if (this.toString != null && this.toString.length() > 0) {
            this.values.valueOf("h4", this.toString);
        }
        ag$a();
        long j = -1;
        ...
        this.HaptikSDK$b.ah$a(this.values, j);
    }
}
