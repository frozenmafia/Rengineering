...
public final class MotionPhotoMetadata implements Metadata.Entry {
    ...
    public int hashCode() {
        int ah$a = Longs.ah$a(this.photoStartPosition);
        int ah$a2 = Longs.ah$a(this.photoSize);
        int ah$a3 = Longs.ah$a(this.photoPresentationTimestampUs);
        return ((((((((ah$a + BR.userTeamVM) * 31) + ah$a2) * 31) + ah$a3) * 31) + Longs.ah$a(this.videoStartPosition)) * 31) + Longs.ah$a(this.videoSize);
    }
