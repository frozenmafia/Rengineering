...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Runnable, Callable<Object>, FrameworkSQLiteDatabase.AnonymousClass2 {
    ...
    public ScheduledRunnable(Runnable runnable, InitializationProvider initializationProvider) {
        super(3);
        this.actual = runnable;
        lazySet(0, initializationProvider);
    }
        ...
        try {
            ...
            try {
                ...
                if (obj4 != PARENT_DISPOSED) {
                    ((InitializationProvider) obj4).ah$a(this);
                }
                do {
                    obj5 = get(1);
    ...
    public void dispose() {
        ...
        ((InitializationProvider) obj).ah$a(this);
    }
