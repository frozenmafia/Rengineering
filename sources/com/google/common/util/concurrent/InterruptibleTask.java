...
public abstract class InterruptibleTask<T> extends AtomicReference<Runnable> implements Runnable {
    ...
    private static final Runnable DONE = new InterruptibleTask$ag$a();
    private static final Runnable PARKED = new InterruptibleTask$ag$a();
    ...
    public final void run() {
        ...
        if (compareAndSet(null, currentThread)) {
            ...
            if (z) {
                afterRanInterruptiblySuccess(animateMoveImpl.ag$a(obj));
            }
        }
    }
