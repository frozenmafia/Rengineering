...
public final class PartialsKt$invoke$42 extends Lambda implements isValueChanged<P1, P2, P3, P4, P5, P6, P8, P9, R> {
    final /* synthetic */ Object $p7;
    final /* synthetic */ matchInstances $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$42(matchInstances matchinstances, Object obj) {
        super(8);
    ...
    public final R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P8 p8, P9 p9) {
        return this.$this_invoke.invoke(p1, p2, p3, p4, p5, p6, this.$p7, p8, p9);
    }
}
