...
public final class JWSAlgorithm extends Algorithm {
    ...
    public static final class Family extends AlgorithmFamily<JWSAlgorithm> {
        ...
        static {
            ...
            ED = family3;
            SIGNATURE = new Family((JWSAlgorithm[]) QueryInterceptorProgram.valueOf(family.toArray(new JWSAlgorithm[0]), (JWSAlgorithm[]) family2.toArray(new JWSAlgorithm[0]), (JWSAlgorithm[]) family3.toArray(new JWSAlgorithm[0])));
        }
