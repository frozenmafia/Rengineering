...
public final class StorageModule$deviceId$2 extends Lambda implements Styleable.ArcMotion<String> {
    final /* synthetic */ checkPaneVisibility this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public StorageModule$deviceId$2(checkPaneVisibility checkpanevisibility) {
        super(0);
