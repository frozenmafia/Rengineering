...
public final class ScreenPerformanceHelper$fmpPerformanceLogger$2 extends Lambda implements Styleable.ArcMotion<Compatibility.Api15Impl> {
    final /* synthetic */ setUseCompatPadding this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ScreenPerformanceHelper$fmpPerformanceLogger$2(setUseCompatPadding setusecompatpadding) {
        super(0);
