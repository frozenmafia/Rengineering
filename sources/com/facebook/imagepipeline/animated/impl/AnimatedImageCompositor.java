...
public class AnimatedImageCompositor {
    ...
    public interface Callback {
        FragmentActivity.AnonymousClass1<Bitmap> getCachedBitmap(int i);
    ...
    private int prepareCanvasWithClosestCachedFrame(int i, Canvas canvas) {
        while (i >= 0) {
            ...
            if (i2 == 1) {
                ...
                FragmentActivity.AnonymousClass1<Bitmap> cachedBitmap = this.mCallback.getCachedBitmap(i);
                if (cachedBitmap != null) {
                    try {
                        canvas.drawBitmap(cachedBitmap.HaptikSDK$c(), 0.0f, 0.0f, (Paint) null);
