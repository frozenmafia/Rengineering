...
import o.setProjection;
import o.setUpdateThrottle;
/* loaded from: classes6.dex */
public class SerializedString implements setUpdateThrottle, Serializable {
    private static final setProjection JSON_ENCODER = setProjection.valueOf();
    ...
    public final char[] asQuotedChars() {
        ...
        if (cArr == null) {
            char[] values = JSON_ENCODER.values(this._value);
            this._quotedChars = values;
            return values;
        }
        return cArr;
    }
    ...
    public final byte[] asQuotedUTF8() {
        ...
        if (bArr == null) {
            byte[] valueOf = JSON_ENCODER.valueOf(this._value);
            this._quotedUTF8Ref = valueOf;
            return valueOf;
        }
        return bArr;
    }
    ...
    public final byte[] asUnquotedUTF8() {
        ...
        if (bArr == null) {
            byte[] ag$a = JSON_ENCODER.ag$a(this._value);
            this._unquotedUTF8Ref = ag$a;
            return ag$a;
        }
        return bArr;
    }
    ...
    public int appendQuoted(char[] cArr, int i) {
        ...
        if (cArr2 == null) {
            cArr2 = JSON_ENCODER.values(this._value);
    ...
    public int appendQuotedUTF8(byte[] bArr, int i) {
        ...
        if (bArr2 == null) {
            bArr2 = JSON_ENCODER.valueOf(this._value);
    ...
    public int appendUnquotedUTF8(byte[] bArr, int i) {
        ...
        if (bArr2 == null) {
            bArr2 = JSON_ENCODER.ag$a(this._value);
    ...
    public int writeQuotedUTF8(OutputStream outputStream) throws IOException {
        byte[] bArr = this._quotedUTF8Ref;
        if (bArr == null) {
            bArr = JSON_ENCODER.valueOf(this._value);
    ...
    public int writeUnquotedUTF8(OutputStream outputStream) throws IOException {
        byte[] bArr = this._unquotedUTF8Ref;
        if (bArr == null) {
            bArr = JSON_ENCODER.ag$a(this._value);
