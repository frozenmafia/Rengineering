...
public class ReactQueueConfigurationImpl implements ReactQueueConfiguration {
    ...
    public static ReactQueueConfigurationImpl create(ReactQueueConfigurationSpec reactQueueConfigurationSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        values.put(mainThreadSpec, create);
        MessageQueueThreadImpl messageQueueThreadImpl = (MessageQueueThreadImpl) values.get(reactQueueConfigurationSpec.getJSQueueThreadSpec());
        ...
        MessageQueueThreadImpl messageQueueThreadImpl2 = (MessageQueueThreadImpl) values.get(reactQueueConfigurationSpec.getNativeModulesQueueThreadSpec());
