...
public final /* synthetic */ class NonEmptyListKt$sequence$1 extends FunctionReference implements Styleable.ChangeBounds<ICustomTabsCallback.Default<? extends G, ? extends A>, ICustomTabsCallback.Default<? extends G, ? extends A>> {
    public static final NonEmptyListKt$sequence$1 INSTANCE = new NonEmptyListKt$sequence$1();

    NonEmptyListKt$sequence$1() {
        super(1);
    }
