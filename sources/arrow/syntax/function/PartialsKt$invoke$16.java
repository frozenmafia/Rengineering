...
public final class PartialsKt$invoke$16 extends Lambda implements excludeId<P1, P3, P4, P5, P6, R> {
    final /* synthetic */ Object $p2;
    final /* synthetic */ isValidMatch $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$16(isValidMatch isvalidmatch, Object obj) {
        super(5);
    ...
    public final R invoke(P1 p1, P3 p3, P4 p4, P5 p5, P6 p6) {
        return this.$this_invoke.invoke(p1, this.$p2, p3, p4, p5, p6);
    }
}
