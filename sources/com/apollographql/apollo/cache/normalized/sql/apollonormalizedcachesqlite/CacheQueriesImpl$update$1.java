...
public final class CacheQueriesImpl$update$1 extends Lambda implements Styleable.ChangeBounds<scheduleNext, setAnimationMatrix> {
    final /* synthetic */ String $key;
    final /* synthetic */ String $record;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CacheQueriesImpl$update$1(String str, String str2) {
        super(1);
        this.$record = str;
        this.$key = str2;
    }
    ...
    public final void invoke2(scheduleNext schedulenext) {
        ...
        schedulenext.valueOf(1, this.$record);
        schedulenext.valueOf(2, this.$key);
    }
}
