...
public class AtomicDoubleArray implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        ImmutableLongArray.valueOf builder = ImmutableLongArray.builder();
        for (int i = 0; i < readInt; i++) {
            builder.toString(Double.doubleToRawLongBits(objectInputStream.readDouble()));
        }
        this.longs = new AtomicLongArray(builder.ag$a().toArray());
    }
}
