...
public final class zzdz extends SQLiteOpenHelper {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        zzan.zza(this.zza.zzt.zzay(), sQLiteDatabase, StringSet.messages, "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", null);
    }
