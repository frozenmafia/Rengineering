...
public final class TrackSelectionOverride implements Bundleable {
    ...
    public Bundle toBundle() {
        ...
        bundle.putIntArray(keyForField(1), Ints.ag$a(this.trackIndices));
        return bundle;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ TrackSelectionOverride lambda$static$0(Bundle bundle) {
        return new TrackSelectionOverride(TrackGroup.CREATOR.fromBundle((Bundle) Assertions.checkNotNull(bundle.getBundle(keyForField(0)))), Ints.ag$a((int[]) Assertions.checkNotNull(bundle.getIntArray(keyForField(1)))));
    }
