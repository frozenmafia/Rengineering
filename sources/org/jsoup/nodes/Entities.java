...
public class Entities {
    private static final char[] ag$a = {',', ';'};
    private static final HashMap<String, String> valueOf = new HashMap<>();
    private static final Document.OutputSettings ah$a = new Document.OutputSettings();
    ...
    public static int toString(String str, int[] iArr) {
    ...
    public static void ag$a(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z, boolean z2, boolean z3) throws IOException {
        EscapeMode ah$a2 = outputSettings.ah$a();
        CharsetEncoder valueOf2 = outputSettings.valueOf();
        CoreCharset coreCharset = outputSettings.values;
        ...
        while (i < length) {
            ...
            if (z2) {
                if (doesReturn.valueOf(codePointAt)) {
                    if ((!z3 || z4) && !z5) {
            ...
            if (codePointAt < 65536) {
                ...
                if (c != '\"') {
                    if (c == '&') {
                        ...
                        if (c != '>') {
                            if (c == 160) {
                                if (ah$a2 != EscapeMode.xhtml) {
                                    appendable.append("&nbsp;");
                                } else {
                                    appendable.append("&#xa0;");
                                }
                            } else if (values(coreCharset, c, valueOf2)) {
                                appendable.append(c);
                            } else {
                                toString(appendable, ah$a2, codePointAt);
                            }
                        } else if (!z) {
                            appendable.append("&gt;");
                        } else {
                    ...
                    } else if (!z || ah$a2 == EscapeMode.xhtml) {
                        appendable.append("&lt;");
                    } else {
                        appendable.append(c);
                    }
    ...
    private static void toString(Appendable appendable, EscapeMode escapeMode, int i) throws IOException {
    ...
    /* renamed from: org.jsoup.nodes.Entities$3 */
    /* loaded from: classes5.dex */
    public static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            try {
                values[CoreCharset.utf.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
        }
    }

    private static boolean values(CoreCharset coreCharset, char c, CharsetEncoder charsetEncoder) {
        int i = AnonymousClass3.values[coreCharset.ordinal()];
        if (i == 1) {
            return c < 128;
        } else if (i != 2) {
    ...
    public static void ag$a(EscapeMode escapeMode, String str, int i) {
        int i2;
        ...
        getRawSidecarDevicePosture getrawsidecardeviceposture = new getRawSidecarDevicePosture(str);
        int i3 = 0;
        while (!getrawsidecardeviceposture.getSignupData()) {
            String values = getrawsidecardeviceposture.values('=');
            getrawsidecardeviceposture.ag$a();
            int parseInt = Integer.parseInt(getrawsidecardeviceposture.ah$a(ag$a), 36);
            char HaptikWebView = getrawsidecardeviceposture.HaptikWebView();
            getrawsidecardeviceposture.ag$a();
            if (HaptikWebView == ',') {
                i2 = Integer.parseInt(getrawsidecardeviceposture.values(';'), 36);
                getrawsidecardeviceposture.ag$a();
            } else {
                i2 = -1;
            }
            int parseInt2 = Integer.parseInt(getrawsidecardeviceposture.values('&'), 36);
            getrawsidecardeviceposture.ag$a();
            escapeMode.nameKeys[i3] = values;
            escapeMode.codeVals[i3] = parseInt;
            escapeMode.codeKeys[parseInt2] = parseInt;
            escapeMode.nameVals[parseInt2] = values;
            if (i2 != -1) {
                valueOf.put(values, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        isWindowLayoutProviderValid.ag$a(i3 == i, "Unexpected count of entities loaded");
    }
}
