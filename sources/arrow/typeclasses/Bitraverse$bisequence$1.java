...
public final /* synthetic */ class Bitraverse$bisequence$1 extends FunctionReference implements Styleable.ChangeBounds<ICustomTabsCallback.Default<? extends G, ? extends A>, ICustomTabsCallback.Default<? extends G, ? extends A>> {
    public static final Bitraverse$bisequence$1 INSTANCE = new Bitraverse$bisequence$1();

    Bitraverse$bisequence$1() {
        super(1);
    }
