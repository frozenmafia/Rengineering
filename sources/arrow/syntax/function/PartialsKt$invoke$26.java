...
public final class PartialsKt$invoke$26 extends Lambda implements isValidMatch<P1, P2, P3, P4, P5, P7, R> {
    final /* synthetic */ Object $p6;
    final /* synthetic */ matchIds $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$26(matchIds matchids, Object obj) {
        super(6);
    ...
    public final R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P7 p7) {
        return this.$this_invoke.invoke(p1, p2, p3, p4, p5, this.$p6, p7);
    }
}
