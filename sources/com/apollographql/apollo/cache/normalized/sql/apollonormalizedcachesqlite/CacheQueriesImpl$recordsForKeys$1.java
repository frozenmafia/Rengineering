...
public final class CacheQueriesImpl$recordsForKeys$1 extends Lambda implements Styleable.ChangeBounds<Transaction, T> {
    final /* synthetic */ Transition $mapper;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CacheQueriesImpl$recordsForKeys$1(Transition transition) {
        super(1);
