...
interface zzabk {
    ...
    @Deprecated
    <T> void zzC(List<T> list, zzabl<T> zzablVar, zzzj zzzjVar) throws IOException;

    void zzD(List<Integer> list) throws IOException;

    void zzE(List<Long> list) throws IOException;

    <T> void zzF(List<T> list, zzabl<T> zzablVar, zzzj zzzjVar) throws IOException;
    ...
    @Deprecated
    <T> T zzr(zzabl<T> zzablVar, zzzj zzzjVar) throws IOException;

    <T> T zzs(zzabl<T> zzablVar, zzzj zzzjVar) throws IOException;
