...
final class UpiWebViewActivity$checksum$2 extends Lambda implements Styleable.ArcMotion<String> {
    final /* synthetic */ UpiWebViewActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UpiWebViewActivity$checksum$2(UpiWebViewActivity upiWebViewActivity) {
        super(0);
