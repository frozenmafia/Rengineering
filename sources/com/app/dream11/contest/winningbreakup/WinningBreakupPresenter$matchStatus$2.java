...
public final class WinningBreakupPresenter$matchStatus$2 extends Lambda implements Styleable.ArcMotion<String> {
    final /* synthetic */ setSpinEnabled this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WinningBreakupPresenter$matchStatus$2(setSpinEnabled setspinenabled) {
        super(0);
    ...
    public final String invoke() {
        ...
        return (winningDataFlowState == null || (matchStatus = winningDataFlowState.getMatchStatus()) == null) ? "" : matchStatus;
    }
}
