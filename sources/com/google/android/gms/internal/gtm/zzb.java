...
public enum zzb {
    ...
    ANY_OF("any_of"),
    APP_NAME(com.apxor.androidsdk.core.Constants.APP_NAME),
    APP_VERSION(com.apxor.androidsdk.core.Constants.VERSION),
    ARG0("arg0"),
    ARG1("arg1"),
    ATTRIBUTE("attribute"),
    ...
    CATEGORY(com.apxor.androidsdk.core.Constants.CATEGORY),
    ...
    HTML("html"),
    ID(values(null, null, KeyEvent.normalizeMetaState(0) + 127, new byte[]{-126, -127}).intern()),
    ...
    LOCALE(com.facebook.hermes.intl.Constants.LOCALE),
    LOCATION("location"),
    ...
    NUMBER(com.apxor.androidsdk.core.Constants.CHUNK_NUMBER),
    ...
    PIXEL("pixel"),
    PLACEMENT("placement"),
    PLATFORM(com.apxor.androidsdk.core.Constants.PLATFORM),
    POSITION("position"),
    PRICES("prices"),
    ...
    TITLE(values(null, null, TextUtils.indexOf((CharSequence) "", '0', 0) + 128, new byte[]{-123, -124, -125, -127, -125}).intern()),
    ...
    static void ah$a() {
        ...
        valueOf = true;
        ag$a = 176;
        values = new char[]{281, 276, 292, 284, 277};
    }
