...
public class HyperSpline {
    ...
    static Cubic[] calcNaturalCubic(int i, double[] dArr) {
        ...
        dArr3[i3] = (((dArr[i3] - dArr[i6]) * 3.0d) - dArr3[i6]) * dArr2[i3];
        dArr4[i3] = dArr3[i3];
        while (i6 >= 0) {
        ...
        while (i4 < i3) {
            int i9 = i4 + 1;
            cubicArr[i4] = new Cubic((float) dArr[i4], dArr4[i4], (((dArr[i9] - dArr[i4]) * 3.0d) - (dArr4[i4] * 2.0d)) - dArr4[i9], ((dArr[i4] - dArr[i9]) * 2.0d) + dArr4[i4] + dArr4[i9]);
            i4 = i9;
        }
        return cubicArr;
    }
