...
public final /* synthetic */ class SequenceKKt$sequence$1 extends FunctionReference implements Styleable.ChangeBounds<ICustomTabsCallback.Default<? extends G, ? extends A>, ICustomTabsCallback.Default<? extends G, ? extends A>> {
    public static final SequenceKKt$sequence$1 INSTANCE = new SequenceKKt$sequence$1();

    SequenceKKt$sequence$1() {
        super(1);
    }
