...
public final class PartialsKt$invoke$4 extends Lambda implements Transition<P1, P3, R> {
    final /* synthetic */ Object $p2;
    final /* synthetic */ excludeObject $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$4(excludeObject excludeobject, Object obj) {
        super(2);
    ...
    public final R invoke(P1 p1, P3 p3) {
        return this.$this_invoke.invoke(p1, this.$p2, p3);
    }
}
