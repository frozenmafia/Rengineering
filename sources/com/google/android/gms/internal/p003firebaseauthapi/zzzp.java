...
public enum zzzp {
    ...
    static {
        zzzp[] values = values();
        zzZ = new zzzp[values.length];
        for (zzzp zzzpVar : values) {
            zzZ[zzzpVar.zzac] = zzzpVar;
        }
    }

    zzzp(int i, int i2, zzaaf zzaafVar) {
        this.zzac = i;
        this.zzab = zzaafVar;
        zzaaf zzaafVar2 = zzaaf.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.zzad = zzaafVar.zza();
        } else if (i3 != 3) {
            this.zzad = null;
        } else {
            this.zzad = zzaafVar.zza();
