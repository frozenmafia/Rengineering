...
public final class CreateTeamAnalyticsHelper$Companion$sendTeamBackPressedEvent$1 extends Lambda implements Styleable.ArcMotion<setAnimationMatrix> {
    ...
    public CreateTeamAnalyticsHelper$Companion$sendTeamBackPressedEvent$1(int i, int i2, String str, String str2, handleServiceConnected handleserviceconnected) {
        super(0);
        this.$roundId = i;
        this.$tourId = i2;
        this.$type = str;
    ...
    public final void invoke2() {
        NewEvents newEvents = new NewEvents("Create Team Back Button Tapped", EventCategory.CONTEST);
        ...
        newEvents.addProperty("screen", this.$type);
        newEvents.addProperty("screen", this.$type);
        newEvents.addProperty("snapshotId", this.$snapshotId);
