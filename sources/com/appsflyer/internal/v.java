...
final class v {
    ...
    private static boolean AFKeystoreWrapper(Context context, String[] strArr) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x004e, code lost:
        if (60000 < (r3.getTime() - r11.getTime())) goto L12;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public final android.location.Location AFInAppEventParameterName(android.content.Context r11) {
        /*
            r10 = this;
            ...
            boolean r3 = AFKeystoreWrapper(r11, r3)     // Catch: java.lang.Throwable -> L55
            if (r3 == 0) goto L1e
        ...
        L1f:
            ...
            boolean r11 = AFKeystoreWrapper(r11, r0)     // Catch: java.lang.Throwable -> L55
            if (r11 == 0) goto L30
        ...
        L55:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.v.AFInAppEventParameterName(android.content.Context):android.location.Location");
    }
}
