...
final class SortedLists {
    ...
    public static <E, K> int ah$a(List<E> list, hasPendingUpdates<? super E, K> haspendingupdates, K k, Comparator<? super K> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        return ag$a(Lists.ag$a(list, haspendingupdates), k, comparator, keyPresentBehavior, keyAbsentBehavior);
    }

    public static <E> int ag$a(List<? extends E> list, E e, Comparator<? super E> comparator, KeyPresentBehavior keyPresentBehavior, KeyAbsentBehavior keyAbsentBehavior) {
        markViewHoldersUpdated.toString(comparator);
        markViewHoldersUpdated.toString(list);
        markViewHoldersUpdated.toString(keyPresentBehavior);
        markViewHoldersUpdated.toString(keyAbsentBehavior);
        if (!(list instanceof RandomAccess)) {
            list = Lists.ag$a(list);
        }
        int i = 0;
        int size = list.size() - 1;
        while (i <= size) {
