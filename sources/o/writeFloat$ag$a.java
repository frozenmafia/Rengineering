...
public final class writeFloat$ag$a implements writeByteArray<T> {
    final /* synthetic */ Iterator ah$a;
    ...
    */
    public java.lang.Object collect(o.writeCharArray<? super T> r5, o.setPatternPath<? super o.setAnimationMatrix> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4$1
            if (r0 == 0) goto L14
            r0 = r6
        ...
        L5b:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: o.writeFloat$ag$a.collect(o.writeCharArray, o.setPatternPath):java.lang.Object");
    }
}
