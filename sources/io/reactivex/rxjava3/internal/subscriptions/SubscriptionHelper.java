...
public enum SubscriptionHelper implements getSidecarVersion {
    ...
    public static void reportSubscriptionSet() {
        endMetadataList.valueOf(new ProtocolViolationException("Subscription already set!"));
    }

    public static boolean validate(long j) {
        if (j <= 0) {
            endMetadataList.valueOf(new IllegalArgumentException("n > 0 required but it was " + j));
            return false;
        }
        return true;
    }
    ...
    public static void reportMoreProduced(long j) {
        endMetadataList.valueOf(new ProtocolViolationException("More produced than requested: " + j));
    }
    ...
    public static void deferredRequest(AtomicReference<getSidecarVersion> atomicReference, AtomicLong atomicLong, long j) {
        ...
        if (getsidecarversion != null) {
            ...
            codepointsLength.ag$a(atomicLong, j);
