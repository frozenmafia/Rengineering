...
public final class LinearSmoothScroller {
    static final Map<String, String> ag$a;
    ...
    public static Status toString(String str) {
        try {
            JSONObject jSONObject = new JSONObject(str);
            String string = jSONObject.getString("code");
            String string2 = jSONObject.getString("message");
            if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2)) {
                Map<String, String> map = ag$a;
                if (map.containsKey(string)) {
                    ...
                    sb.append(":");
                    sb.append(string2);
                    return shouldMeasureTwice.valueOf(sb.toString());
                }
            }
            String valueOf = String.valueOf(str);
            return shouldMeasureTwice.valueOf(valueOf.length() != 0 ? "WEB_INTERNAL_ERROR:".concat(valueOf) : new String("WEB_INTERNAL_ERROR:"));
            ...
            sb2.append(" ]");
            return shouldMeasureTwice.valueOf(sb2.toString());
        }
    }

    public static void valueOf(Intent intent, Status status) {
