...
public final class WorkInfo {
    ...
    public int hashCode() {
        ...
        int hashCode3 = this.mOutputData.hashCode();
        return (((((((((hashCode * 31) + hashCode2) * 31) + hashCode3) * 31) + this.mTags.hashCode()) * 31) + this.mProgress.hashCode()) * 31) + this.mRunAttemptCount;
    }
