...
public class ReanimatedSensorContainer {
    ...
    public int registerSensor(ReanimatedSensorType reanimatedSensorType, int i, NativeProxy.SensorSetter sensorSetter) {
        if (new ReanimatedSensor(this.reactContext, reanimatedSensorType, i, sensorSetter).initialize()) {
            int i2 = this.nextSensorId;
            this.nextSensorId = i2 + 1;
            this.sensors.put(Integer.valueOf(i2), new ReanimatedSensor(this.reactContext, reanimatedSensorType, i, sensorSetter));
            return i2;
        }
        return -1;
    }
