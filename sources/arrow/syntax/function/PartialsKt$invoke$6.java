...
public final class PartialsKt$invoke$6 extends Lambda implements excludeObject<P2, P3, P4, R> {
    final /* synthetic */ Object $p1;
    final /* synthetic */ captureHierarchy $this_invoke;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PartialsKt$invoke$6(captureHierarchy capturehierarchy, Object obj) {
        super(3);
    ...
    public final R invoke(P2 p2, P3 p3, P4 p4) {
        return this.$this_invoke.invoke(this.$p1, p2, p3, p4);
    }
}
