...
import o.lambda$beginTransactionWithListener$2$androidxroomQueryInterceptorDatabase;
...
public final class Curve implements Serializable {
    ...
    public ECParameterSpec toECParameterSpec() {
        return lambda$beginTransactionWithListener$2$androidxroomQueryInterceptorDatabase.toString(this);
    }
    ...
    public static Curve forECParameterSpec(ECParameterSpec eCParameterSpec) {
        return lambda$beginTransactionWithListener$2$androidxroomQueryInterceptorDatabase.values(eCParameterSpec);
    }
}
