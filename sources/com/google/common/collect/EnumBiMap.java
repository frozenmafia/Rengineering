...
public final class EnumBiMap<K extends Enum<K>, V extends Enum<V>> extends AbstractBiMap<K, V> {
    ...
    @Override // com.google.common.collect.AbstractBiMap, o.isRequestedGeneration, java.util.Map
    ...
    @Override // com.google.common.collect.AbstractBiMap, o.latchList
    public /* bridge */ /* synthetic */ Object forcePut(Object obj, Object obj2) {
        return super.forcePut(obj, obj2);
    }

    @Override // com.google.common.collect.AbstractBiMap, o.latchList
    public /* bridge */ /* synthetic */ latchList inverse() {
    ...
    @Override // com.google.common.collect.AbstractBiMap, o.isRequestedGeneration, java.util.Map, o.latchList
    ...
    public static <K extends Enum<K>> Class<K> inferKeyType(Map<K, ?> map) {
        ...
        markViewHoldersUpdated.values(!map.isEmpty());
    ...
    K checkKey(K k) {
        return (K) markViewHoldersUpdated.toString(k);
    }

    V checkValue(V v) {
        return (V) markViewHoldersUpdated.toString(v);
    }
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        unhideViewInternal.toString(this, objectOutputStream);
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        unhideViewInternal.toString(this, objectInputStream);
    }
}
