...
public final class ExitOrBlockUserVM$cancelClicked$1 extends Lambda implements Styleable.ArcMotion<setAnimationMatrix> {
    final /* synthetic */ ExitOrBlockUserVM.ExitOrBlockUserHandler $handler;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ExitOrBlockUserVM$cancelClicked$1(ExitOrBlockUserVM.ExitOrBlockUserHandler exitOrBlockUserHandler) {
        super(0);
    ...
    public final setAnimationMatrix invoke() {
        ...
        exitOrBlockUserHandler.onCancelClicked();
