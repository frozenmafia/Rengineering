...
public final class MapFieldLite<K, V> extends LinkedHashMap<K, V> {
    ...
    public V put(K k, V v) {
        ensureMutable();
        ViewInfoStore.valueOf(k);
        ViewInfoStore.valueOf(v);
    ...
    private static void checkForNullKeysAndValues(Map<?, ?> map) {
        for (Object obj : map.keySet()) {
            ViewInfoStore.valueOf(obj);
            ViewInfoStore.valueOf(map.get(obj));
        }
    }
    ...
    */
    ...
    private static int calculateHashCodeForObject(Object obj) {
        ...
        if (!(obj instanceof byte[])) {
            if (obj instanceof ViewInfoStore$ah$a) {
                throw new UnsupportedOperationException();
            }
            return obj.hashCode();
        }
        ah$a = ViewInfoStore.ah$a(r1, 0, ((byte[]) obj).length);
        return ah$a;
    }
