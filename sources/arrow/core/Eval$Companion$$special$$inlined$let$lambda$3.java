...
public final class Eval$Companion$$special$$inlined$let$lambda$3 extends Lambda implements Styleable.ChangeBounds<Object, asBinder<? extends A>> {
    ...
    public Eval$Companion$$special$$inlined$let$lambda$3(asBinder.toString tostring, Ref.ObjectRef objectRef, List list, Eval$Companion$evaluate$1$1 eval$Companion$evaluate$1$1) {
        super(1);
