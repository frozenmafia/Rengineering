...
public class WebsocketJavaScriptExecutor implements JavaJSExecutor {
    ...
    public void loadBundle(String str) throws JavaJSExecutor.ProxyExecutorException {
        ...
        ((JSDebuggerWebSocketClient) FragmentLifecycleCallbacksDispatcher.FragmentLifecycleCallbacksHolder.ag$a(this.mWebSocketClient)).loadBundle(str, this.mInjectedObjects, jSExecutorCallbackFuture);
        try {
    ...
    public String executeJSCall(String str, String str2) throws JavaJSExecutor.ProxyExecutorException {
        JSExecutorCallbackFuture jSExecutorCallbackFuture = new JSExecutorCallbackFuture();
        ((JSDebuggerWebSocketClient) FragmentLifecycleCallbacksDispatcher.FragmentLifecycleCallbacksHolder.ag$a(this.mWebSocketClient)).executeJSCall(str, str2, jSExecutorCallbackFuture);
        try {
