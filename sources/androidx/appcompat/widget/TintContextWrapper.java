...
public class TintContextWrapper extends ContextWrapper {
    ...
    private static boolean shouldWrap(Context context) {
        return ((context instanceof TintContextWrapper) || (context.getResources() instanceof TintResources) || (context.getResources() instanceof VectorEnabledTintResources) || (Build.VERSION.SDK_INT >= 21 && !VectorEnabledTintResources.shouldBeUsed())) ? false : true;
    }
