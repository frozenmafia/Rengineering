...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSelected()) {
            ...
            canvas.drawCircle((this.mCanvasClipBounds.right - this.mCanvasClipBounds.left) / 2.0f, (this.mCanvasClipBounds.bottom - (this.mCanvasClipBounds.top / 2.0f)) - (f * 1.5f), f / 2.0f, this.mDotPaint);
        }
    }
