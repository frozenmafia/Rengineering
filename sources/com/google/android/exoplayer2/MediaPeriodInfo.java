...
final class MediaPeriodInfo {
    ...
    public int hashCode() {
        ...
        int i = (int) this.startPositionUs;
        int i2 = (int) this.requestedContentPositionUs;
        int i3 = (int) this.endPositionUs;
        return ((((((((((((((((hashCode + BR.userTeamVM) * 31) + i) * 31) + i2) * 31) + i3) * 31) + ((int) this.durationUs)) * 31) + (this.isFollowedByTransitionToSameStream ? 1 : 0)) * 31) + (this.isLastInTimelinePeriod ? 1 : 0)) * 31) + (this.isLastInTimelineWindow ? 1 : 0)) * 31) + (this.isFinal ? 1 : 0);
    }
}
