...
public enum FieldType {
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = AnonymousClass1.ah$a[collection.ordinal()];
        boolean z = true;
        if (i3 == 1) {
        ...
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = AnonymousClass1.ag$a[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : false;
    }
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                ag$a[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                ag$a[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                ah$a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                ah$a[Collection.SCALAR.ordinal()] = 3;
