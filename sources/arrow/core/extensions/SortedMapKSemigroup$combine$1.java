...
public final class SortedMapKSemigroup$combine$1 extends Lambda implements Transition<ITrustedWebActivityCallback.Default<A, B>, cancel<? extends A, ? extends B>, ITrustedWebActivityCallback.Default<A, B>> {
    final /* synthetic */ getIconUri this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SortedMapKSemigroup$combine$1(getIconUri geticonuri) {
        super(2);
