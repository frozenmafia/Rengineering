...
public final class ListK$map2$1 extends Lambda implements Styleable.ChangeBounds<A, newSession<? extends Z>> {
    final /* synthetic */ Styleable.ChangeBounds $f;
    final /* synthetic */ ICustomTabsCallback.Default $fb;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ListK$map2$1(ICustomTabsCallback.Default r1, Styleable.ChangeBounds changeBounds) {
        super(1);
        this.$fb = r1;
        this.$f = changeBounds;
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return invoke((ListK$map2$1) obj);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: arrow.core.ListK$map2$1$1  reason: invalid class name */
    /* loaded from: classes6.dex */
    public static final class AnonymousClass1 extends Lambda implements Styleable.ChangeBounds<B, Z> {
        ...
        public final Z invoke(B b2) {
            return ListK$map2$1.this.$f.invoke(new cancel(this.$a, b2));
        }
    }

    @Override // o.Styleable.ChangeBounds
    public final newSession<Z> invoke(A a) {
