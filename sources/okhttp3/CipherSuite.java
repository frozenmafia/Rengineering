...
public final class CipherSuite {
    ...
    public /* synthetic */ CipherSuite(String str, getTargetTypes gettargettypes) {
        this(str);
    }
    ...
    public final String m1284deprecated_javaName() {
        return this.javaName;
    }
    ...
    public static final class Companion {
        ...
        public final CipherSuite forJavaName(String str) {
            ...
            synchronized (this) {
                runAnimators.ag$a(str, "javaName");
        ...
        private final String secondaryName(String str) {
            if (Visibility.Mode.ah$a(str, "TLS_", false, 2, (Object) null)) {
                ...
                sb.append(substring);
                return sb.toString();
            } else if (Visibility.Mode.ah$a(str, "SSL_", false, 2, (Object) null)) {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                runAnimators.ag$a(str, "a");
                runAnimators.ag$a(str2, "b");
                int min = Math.min(str.length(), str2.length());
                for (int i = 4; i < min; i++) {
                    char charAt = str.charAt(i);
                    char charAt2 = str2.charAt(i);
                    if (charAt != charAt2) {
                        return runAnimators.toString(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
