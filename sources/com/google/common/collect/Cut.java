...
public abstract class Cut<C extends Comparable> implements Comparable<Cut<C>>, Serializable {
    ...
    public int compareTo(Cut<C> cut) {
        ...
        return compareOrThrow != 0 ? compareOrThrow : Booleans.toString(this instanceof AboveValue, cut instanceof AboveValue);
    }
    ...
    public static final class BelowValue<C extends Comparable> extends Cut<C> {
        ...
        BelowValue(C c) {
            super((Comparable) markViewHoldersUpdated.toString(c));
        }
        ...
        Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> discreteDomain) {
            int i = AnonymousClass5.valueOf[boundType.ordinal()];
            if (i != 1) {
                if (i == 2) {
    ...
    /* renamed from: com.google.common.collect.Cut$5  reason: invalid class name */
    /* loaded from: classes7.dex */
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            ...
            try {
                valueOf[BoundType.OPEN.ordinal()] = 2;
