...
public final class GlUtil {
    ...
    public static String loadAsset(Context context, String str) throws IOException {
        ...
        try {
            try {
                if (i % 2 == 0) {
                    InputStream inputStream = (InputStream) ((Class) AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$$ExternalSyntheticLambda2.valueOf(Color.green(0), (char) (1 - (android.os.SystemClock.elapsedRealtime() > 0L ? 1 : (android.os.SystemClock.elapsedRealtime() == 0L ? 0 : -1))), 87 - TextUtils.getCapsMode("", 0, 0))).getMethod("ah$a", AssetManager.class, String.class).invoke(null, context.getAssets(), str);
                    fromUtf8Bytes = Util.fromUtf8Bytes(Util.toByteArray(inputStream));
                    Util.closeQuietly(inputStream);
                    super.hashCode();
                    context = inputStream;
                } else {
                    InputStream inputStream2 = (InputStream) ((Class) AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$$ExternalSyntheticLambda2.valueOf(ViewConfiguration.getLongPressTimeout() >> 16, (char) KeyEvent.keyCodeFromString(""), 87 - KeyEvent.getDeadChar(0, 0))).getMethod("ah$a", AssetManager.class, String.class).invoke(null, context.getAssets(), str);
                    fromUtf8Bytes = Util.fromUtf8Bytes(Util.toByteArray(inputStream2));
                    try {
