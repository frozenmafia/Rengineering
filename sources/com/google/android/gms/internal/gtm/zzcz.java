...
public final class zzcz {
    ...
    public static boolean zzb(String str, boolean z) {
        if (str == null || str.equalsIgnoreCase("true") || str.equalsIgnoreCase("yes") || str.equalsIgnoreCase(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE)) {
            return true;
        }
        return (str.equalsIgnoreCase(Constants.CASEFIRST_FALSE) || str.equalsIgnoreCase("no") || str.equalsIgnoreCase(SessionDescription.SUPPORTED_SDP_VERSION)) ? false : true;
    }
    ...
    public static void zzb(Map<String, String> map, String str, boolean z) {
        ...
        map.put(str, z ? IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE : SessionDescription.SUPPORTED_SDP_VERSION);
    }
