...
import o.getFragmentStateManager;
import o.setBreadCrumbTitle;
/* loaded from: classes6.dex */
public class DevInternalSettings implements getFragmentStateManager, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final setBreadCrumbTitle mPackagerConnectionSettings;
    ...
    public DevInternalSettings(Context context, Listener listener) {
        ...
        this.mPackagerConnectionSettings = new setBreadCrumbTitle(context);
    }

    public setBreadCrumbTitle getPackagerConnectionSettings() {
    ...
    @Override // o.getFragmentStateManager
