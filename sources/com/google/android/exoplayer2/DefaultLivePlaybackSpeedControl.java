...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        if (this.currentTargetLiveOffsetUs > j2) {
            ...
            this.currentTargetLiveOffsetUs = Longs.ah$a(j2, this.idealTargetLiveOffsetUs, this.currentTargetLiveOffsetUs - (((this.adjustedPlaybackSpeed - 1.0f) * msToUs) + ((this.maxPlaybackSpeed - 1.0f) * msToUs)));
            return;
        }
