...
import o.QueryInterceptorProgram;
...
public final class JWEAlgorithm extends Algorithm {
    ...
    public static final class Family extends AlgorithmFamily<JWEAlgorithm> {
        ...
        static {
            ...
            ASYMMETRIC = new Family((JWEAlgorithm[]) QueryInterceptorProgram.valueOf(family.toArray(new JWEAlgorithm[0]), (JWEAlgorithm[]) family3.toArray(new JWEAlgorithm[0])));
            SYMMETRIC = new Family((JWEAlgorithm[]) QueryInterceptorProgram.valueOf(family2.toArray(new JWEAlgorithm[0]), (JWEAlgorithm[]) family4.toArray(new JWEAlgorithm[0]), new JWEAlgorithm[]{JWEAlgorithm.DIR}));
        }
