...
public final class MapKSemigroup$combine$1$2 extends Lambda implements Transition<requestPostMessageChannelWithExtras<K, ? extends A>, cancel<? extends K, ? extends A>, requestPostMessageChannelWithExtras<K, ? extends A>> {
    final /* synthetic */ isCaptioningEnabled $this_with;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MapKSemigroup$combine$1$2(isCaptioningEnabled iscaptioningenabled) {
        super(2);
