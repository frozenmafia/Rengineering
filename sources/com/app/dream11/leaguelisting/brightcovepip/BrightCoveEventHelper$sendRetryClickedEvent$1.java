...
public final class BrightCoveEventHelper$sendRetryClickedEvent$1 extends Lambda implements Styleable.ArcMotion<setAnimationMatrix> {
    ...
    public BrightCoveEventHelper$sendRetryClickedEvent$1(setType settype, int i, String str, int i2, int i3, String str2) {
        super(0);
        this.this$0 = settype;
        this.$fcMatchId = i;
        this.$screenMode = str;
    ...
    public final void invoke2() {
        NewEvents newEvents = new NewEvents("VideoPlayerRetryButton");
        ...
        newEvents.addProperty("errorReason", str2);
