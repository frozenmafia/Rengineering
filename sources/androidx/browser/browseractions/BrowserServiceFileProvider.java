...
public final class BrowserServiceFileProvider extends FileProvider {
                ...
                synchronized (BrowserServiceFileProvider.sFileCleanupLock) {
                    ...
                    if (file.exists()) {
                        ...
                        for (File file2 : listFiles) {
                            if (isImageFile(file2) && file2.lastModified() < currentTimeMillis2 - j && !file2.delete()) {
    ...
    public static animateAddImpl<Bitmap> loadBitmap(final ContentResolver contentResolver, final Uri uri) {
