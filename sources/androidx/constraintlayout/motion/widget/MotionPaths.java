...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f14 = (motionPaths2.x + (motionPaths2.width / 2.0f)) - ((f11 / 2.0f) + f10);
        float f15 = (motionPaths2.y + (motionPaths2.height / 2.0f)) - ((f13 / 2.0f) + f12);
        float f16 = f14 * f3;
        float f17 = ((f6 - f7) * f4) / 2.0f;
        this.x = (int) ((f10 + f16) - f17);
        float f18 = f3 * f15;
        float f19 = ((f8 - f9) * f5) / 2.0f;
        this.y = (int) ((f12 + f18) - f19);
        this.width = (int) (f11 + f);
        this.height = (int) (f13 + f2);
        float f20 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f21 = (int) ((motionPaths.x + f16) - f17);
        this.x = f21;
        float f22 = (int) ((motionPaths.y + f18) - f19);
        this.y = f22;
        this.x = f21 + ((-f15) * f20);
        this.y = f22 + (f14 * f20);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
    ...
    public void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (Float.isNaN(f7)) {
            ...
            view.setRotation((float) ((Float.isNaN(Float.NaN) ? 0.0f : Float.NaN) + f7 + Math.toDegrees(Math.atan2(f8 + (f9 / 2.0f), f11 + (f10 / 2.0f)))));
        }
        float f14 = f13 + 0.5f;
        int i4 = (int) f14;
        float f15 = f4 + 0.5f;
