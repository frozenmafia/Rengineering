...
final class zzzq extends zzyf<Float> implements RandomAccess, zzaab, zzabg {
    ...
    static {
        zzzq zzzqVar = new zzzq(new float[0], 0);
        zza = zzzqVar;
        zzzqVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzzqVar.zzb, 0, this.zzb, this.zzc, zzzqVar.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzzqVar.zzc) {
            return false;
        }
        float[] fArr = zzzqVar.zzb;
