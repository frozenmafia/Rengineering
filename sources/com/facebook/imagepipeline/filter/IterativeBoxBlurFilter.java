...
public abstract class IterativeBoxBlurFilter {
    ...
    public static void boxBlurBitmapInPlace(Bitmap bitmap, int i, int i2) {
        ...
        Fragment.AnonymousClass8.valueOf(Boolean.valueOf(((float) bitmap.getHeight()) <= 2048.0f));
        Fragment.AnonymousClass8.valueOf(Boolean.valueOf(((float) bitmap.getWidth()) <= 2048.0f));
        Fragment.AnonymousClass8.valueOf(Boolean.valueOf(i2 > 0 && i2 <= 25));
        Fragment.AnonymousClass8.valueOf(Boolean.valueOf(i > 0));
        try {
            fastBoxBlur(bitmap, i, i2);
        } catch (OutOfMemoryError e) {
            FragmentActivity.values(TAG, String.format(null, "OOM: %d iterations on %dx%d with %d radius", Integer.valueOf(i), Integer.valueOf(bitmap.getWidth()), Integer.valueOf(bitmap.getHeight()), Integer.valueOf(i2)));
            throw e;
        }
    }
