...
import o.syncCheckboxView;
/* loaded from: classes7.dex */
public abstract class NetworkConnectionInfo {

    /* loaded from: classes7.dex */
    public static abstract class values {
        public abstract NetworkConnectionInfo ag$a();

        public abstract values ah$a(MobileSubtype mobileSubtype);

        public abstract values toString(NetworkType networkType);
    }

    public abstract MobileSubtype ah$a();

    public abstract NetworkType valueOf();
    ...
    public static values values() {
        return new syncCheckboxView.valueOf();
    }
}
