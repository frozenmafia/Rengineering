...
public class OperatorNode extends Node {
    ...
    /* loaded from: classes7.dex */
    static abstract class ReduceOperator implements Operator {
    ...
    /* loaded from: classes7.dex */
    static abstract class SingleOperator implements Operator {
    ...
    /* loaded from: classes7.dex */
    static abstract class CompOperator implements Operator {
    ...
    public OperatorNode(int i, ReadableMap readableMap, NodesManager nodesManager) {
        ...
        } else if (StringSet.and.equals(string)) {
            this.mOperator = AND;
        } else if (StringSet.or.equals(string)) {
            this.mOperator = OR;
