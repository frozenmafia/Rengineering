...
public final class LoginPresenter$loginPageHandler$1$onFacebookClick$1 extends Lambda implements Styleable.ChangeBounds<Map<String, Serializable>, setAnimationMatrix> {
    final /* synthetic */ reEvaluateState this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LoginPresenter$loginPageHandler$1$onFacebookClick$1(reEvaluateState reevaluatestate) {
        super(1);
