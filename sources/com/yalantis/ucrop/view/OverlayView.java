        ...
        if (this.mShowCropGrid) {
            if (this.mGridPoints == null && !this.mCropViewRect.isEmpty()) {
                ...
                while (i3 < this.mCropGridRowCount) {
                    ...
                    int i5 = i4 + 1;
                    float f = i3 + 1.0f;
                    this.mGridPoints[i4] = (this.mCropViewRect.height() * (f / (this.mCropGridRowCount + 1))) + this.mCropViewRect.top;
                    int i6 = i5 + 1;
                    this.mGridPoints[i5] = this.mCropViewRect.right;
                    this.mGridPoints[i6] = (this.mCropViewRect.height() * (f / (this.mCropGridRowCount + 1))) + this.mCropViewRect.top;
                    i3++;
                    i2 = i6 + 1;
                }
