...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public int hashCode() {
            ...
            return ((((((((((((((((((((((((((((hashCode + 217) * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + i) * 31) + i2) * 31) + i3) * 31) + (z ? 1 : 0)) * 31) + (z2 ? 1 : 0)) * 31) + (z3 ? 1 : 0)) * 31) + i4) * 31) + i5) * 31) + i6) * 31) + i7) * 31) + ((int) ((j6 >>> 32) ^ j6));
        }
    ...
    public static final class Period implements Bundleable {
        ...
        public int hashCode() {
            ...
            return ((((((((((((hashCode + 217) * 31) + hashCode2) * 31) + i) * 31) + i2) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + (this.isPlaceholder ? 1 : 0)) * 31) + this.adPlaybackState.hashCode();
        }
    ...
    private static <T extends Bundleable> ImmutableList<T> fromBundleListRetriever(Bundleable.Creator<T> creator, IBinder iBinder) {
        ...
        for (int i = 0; i < list.size(); i++) {
            valueof.toString((ImmutableList.valueOf) creator.fromBundle(list.get(i)));
        }
        return valueof.ah$a();
    }
